...
function Sidebar({ openModalFunc }) {
  ...
  const handleToggleSubSidebar = (e) => {
    const type = e.target.closest('.sidebarMain__item-wrapper').dataset.type;
    settypeSubSidebar(type)
    console.log(typeSubSidebar);
    
    if (typeSubSidebar === type) {
      setToggleSubSidebar(prev => !prev);
    }
    else {
  ...
  return (
    <aside id="sidebar">
        ...
        <div className="flex flex-col justify-between h-full px-3 py-8">
          <div className="sidebarMain__function-wrapper">
            ...
            <ul className="sidebarMain__list-wrapper">
              ...
              <li data-type="search" className="sidebarMain__item-wrapper" onClick={handleToggleSubSidebar}>
                <FontAwesomeIcon
                  icon={faMagnifyingGlass}
                  className={`sidebarMain__item-icon ${toggleSubSidebar ? 'active' : ''}`}
                />
                {
                  toggleSubSidebar ? 
                  <></> :
              ...
              <li data-type="noti" className="sidebarMain__item-wrapper" onClick={handleToggleSubSidebar}>
                <FontAwesomeIcon
                  icon={faHeart}
                  className={`sidebarMain__item-icon ${toggleSubSidebar ? 'active' : ''}`}
                />
      ...
      {
        toggleSubSidebar ? 
        <SubSidebar type={typeSubSidebar} /> :
        <></>
      }
    </aside>
  );
